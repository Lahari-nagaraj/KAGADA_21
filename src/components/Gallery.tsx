...
//           <section className="py-16 sm:py-20 font-roboto-mono overflow-hidden">
...
//   <div className="text-center mb-6 sm:mb-8"> {/* Reduced further */}
//     <h2 className="font-rajdhani text-4xl sm:text-5xl md:text-6xl font-bold text-slate-900 tracking-wider">
//       {children}
//     </h2>
//     <div className="w-28 h-[3px] bg-blue-600/50 mx-auto rounded-full mt-2"></div> {/* Tighter underline */}
//   </div>
// );
...
const SectionTitle: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <div className="text-center mb-6 sm:mb-8">
    ...
    <div className="w-28 h-[3px] bg-blue-600/50 mx-auto rounded-full mt-2"></div>
  </div>
);
...
const Gallery: React.FC = () => {
  ...
  const backgroundStyle = `
    ...
    .scroller { display: flex; width: 200%; }
    .animate-left { animation: scroll-left 20s linear infinite; }
    .animate-right { animation: scroll-right 20s linear infinite; }

    @media (max-width: 640px) {
      .animate-left { animation: scroll-left 15s linear infinite; }
      .animate-right { animation: scroll-right 15s linear infinite; }
    }

    .scroller > div { display: flex; gap: 1.5rem; }
  `;
