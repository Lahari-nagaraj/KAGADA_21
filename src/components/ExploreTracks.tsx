...
const tracks = [
  {
    ...
    title: "Poster Presentation",
    icon: Users,
    description: `Poster presentation provides an opportunity to present innovative ideas through technical posters to depict how real life problems can be solved. Participants are free to choose the domain of their choice and the presentation will be in hybrid mode. Participants can choose their interested mode to present.`,
    img: "https://res.cloudinary.com/dr3ypljez/image/upload/v1759396074/Screenshot_2025-10-02_143440_yoo4lb.png",
    fee: "₹150 per team",
    features: ["Hybrid Format", "Innovation"],
    duration: "15 mins presentation",
  ...
  },
  {
    ...
    title: "Paper Presentation",
    icon: BookOpen,
    description: `Paper presentation competition gives participants a chance to present their technical research papers on their interested domain and lay an initial stone to engrave one's knowledge to serve society with their innovative ideas including categories UG/PG. Paper presentation will be in online mode.`,
    img: "https://res.cloudinary.com/dr3ypljez/image/upload/v1759396194/6950be6b-5651-43e2-8a7e-cade88d16a4d_wize9x.jpg",
    fee: "₹200 per team",
    features: ["Research", "Academic Excellence"],
    duration: "20 mins presentation",
  ...
  },
  {
    ...
    title: "Project Presentation",
    icon: Wrench,
    description: `Project presentation makes way for students to bring out the inventors in them and their creativity to pure reality through working model demonstrations. This also helps them to display their innovative thoughts on different domains.`,
    img: "https://res.cloudinary.com/dr3ypljez/image/upload/v1759396266/20241026_124756_xi3yqo.jpg",
    fee: "₹180 per team",
    features: ["Working Models", "Industry Focus"],
    duration: "25 mins demonstration",
  ...
  },
  {
    ...
    title: "Ottige Kaliyona",
    icon: Heart,
    description: `Ottige Kaliyona conducted by IEEE WIE during KAGADA 25 as an initiative to contribute in uprising of the society, inviting students from a government school for technical education and fun activities.`,
    img: "https://res.cloudinary.com/dr3ypljez/image/upload/v1759396336/_storage_emulated_0_DCIM_Camera_IMG_20241026_105853_a49rdk.jpg",
    fee: "Free",
    features: ["Social Impact", "Education"],
    duration: "Full day event",
  },
  {
    ...
    title: "Food for Cause",
    icon: Coffee,
    description: `The event is conducted b ECE students of UVCE where food stalls serve delicious foods and the profits collected from the same will be donated to an NGO`,
    img: "https://res.cloudinary.com/dr3ypljez/image/upload/v1759396128/Screenshot_2025-10-02_143521_i6bymk.png",
    fee: "As per menu",
    features: ["Charity", "Networking"],
    duration: "Throughout event",
