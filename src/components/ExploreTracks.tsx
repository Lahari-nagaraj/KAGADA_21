...
//     <div className="site-background font-roboto-mono">
//       <style>{backgroundStyle}</style>
//       <section id="tracks" className="py-6 sm:py-10">
//         <div className="container mx-auto px-4">
...
//               <div className="w-[90%] sm:w-full max-w-sm sm:max-w-md lg:max-w-lg">
//                 <TrackCard track={tracks[active]} isActive={true} setPause={setPause} />
//               </div>
...
//   return (
//     <div
//       className={`track-card ${isActive ? "active-card" : "blur-card"} bg-white rounded-xl shadow-lg overflow-hidden flex flex-col justify-between transition-all duration-500 h-auto sm:min-h-[520px]`}
//       onMouseEnter={() => setPause && setPause(true)}
//       onMouseLeave={() => setPause && setPause(false)}
//     >
//       {/* Title */}
//       <div className="bg-slate-800 p-3 text-center">
//         <h3 className="font-rajdhani text-lg sm:text-xl font-bold text-white">{track.title}</h3>
//       </div>
...
//           src={track.img}
//           alt={track.title}
//           className="rounded-lg shadow-md object-cover w-full h-[160px] sm:h-[180px] md:h-[200px]"
//         />
//       </div>

//       {/* Description */}
//       <div className="flex-grow px-3 pt-2 pb-3">
//         <p className="text-slate-900 text-justify text-[13px] sm:text-sm leading-relaxed font-poppins">
//           {track.description}
//         </p>
//       </div>

//       {/* Footer Section — Fee + Registration */}
//       {hasRegisterButton && (
...
//       <section id="tracks" className="py-6 sm:py-10 scroll-mt-24">
//         <div className="container mx-auto px-4">
//           <div className="max-w-4xl mx-auto text-center mb-10 sm:mb-12">
//             <h2 className="font-rajdhani text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-wider">
//               <span className="text-slate-900">Explore Event</span>{" "}
    ...
    <div className="site-background font-roboto-mono">
      ...
      <section id="tracks" className="py-6 sm:py-10 scroll-mt-24">
        <div className="container mx-auto px-4">
          ...
          <div
            ref={tracksRef}
            className={`relative max-w-7xl mx-auto fade-in-up ${
              tracksVisible ? "animate" : ""
            }`}
          >
            <div className="flex flex-col lg:flex-row items-center justify-center gap-4 sm:gap-6 lg:gap-8">
              <div className="hidden lg:block w-full max-w-xs">
...
// ✅ Track Card with Updated Countdown Text
function TrackCard({ track, isActive, setPause }: any) {
  const hasRegisterButton = ["poster", "paper", "project"].includes(track.id);
  ...
  useEffect(() => {
    ...
    const updateCountdown = () => {
      ...
      setTimeLeft(
        `🕒 Registrations open in the countdown of ${hours
          .toString()
  ...
  return (
    <div
      ...
      } bg-white rounded-xl shadow-lg overflow-hidden flex flex-col justify-between transition-all duration-500 h-auto sm:min-h-[520px]`}
      onMouseEnter={() => setPause && setPause(true)}
      onMouseLeave={() => setPause && setPause(false)}
    >
      {/* Title */}
      ...
      {hasRegisterButton && (
        <div className="px-3 pb-4 mt-auto">
          ...
          <div
            className={`w-full py-2 px-3 rounded-lg text-xs sm:text-sm text-center border font-poppins transition-all duration-300 ${
              timeLeft.includes("now open")
                ? "bg-green-50 border-green-300 text-green-700 font-semibold"
                : "bg-blue-50 border-blue-200 text-slate-700 font-medium"
            }`}
          >
            {timeLeft || "Loading..."}
          </div>
...
//     const link = registerLinks[track.id];
...
//       {/* Footer Section — Fee + Register Button */}
//       {hasRegisterButton && (
//         <div className="px-3 pb-4 mt-auto">
//           <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 text-xs sm:text-sm mb-3 text-slate-700 font-poppins shadow-sm flex items-center justify-center">
//             <p className="m-0 text-center">
//               <strong>Fee:</strong> {track.fee}
//             </p>
//           </div>
...
//             className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-3 rounded-lg text-xs sm:text-sm text-center font-poppins transition-all duration-300 shadow-md hover:shadow-lg"
//           >
//             Register Now
//           </button>
//         </div>
