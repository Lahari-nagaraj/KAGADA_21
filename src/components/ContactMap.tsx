                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {contacts.map((item, index) => (
                      ...
                      >
                        ...
                        <p className="text-blue-700 font-semibold text-sm mb-4">{item.designation}</p>
                        <div className="flex items-center gap-2 text-sm text-slate-600 mb-2">
                          <Phone size={14} />
                          <a href={item.phoneLink} className="hover:text-blue-600 hover:underline">
                            {item.phone}
                          </a>
                        </div>
                        <div className="flex items-center gap-2 text-sm text-slate-600">
                          <Mail size={14} />
                          <a href={item.emailLink} className="hover:text-blue-600 hover:underline truncate">
                            {item.email}
                          </a>
                        </div>
                      </div>
                ...
                <div className={`${cardStyle} p-6 sm:p-8 flex justify-center`}>
                  <div className="max-w-xl w-full">
                    <div className="flex items-center justify-between mb-6 w-full">
                      <h3 className="font-rajdhani text-3xl font-bold text-slate-900">Find Us Here</h3>
