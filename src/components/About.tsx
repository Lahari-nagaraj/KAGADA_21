...
//   return (
//     // ✅ Added id="about" for navbar scroll targeting
//     <section id="about">
//       <div className="site-background">
//         <style>{`
//           /* --- Google Font Imports --- */
...
//                 <span className="text-blue-600">UVCE</span>
//               </SectionTitle>
//               <div
//                 ref={uvceRef}
//                 className={`${cardStyle} p-8 sm:p-12 fade-in-up ${uvceVisible ? "animate" : ""}`}
//               >
//                 <div className="grid md:grid-cols-2 gap-12 items-center">
//                   <div className="space-y-6">
//                     <MobileTruncated>
...
//               <SectionTitle>
//                 <span className="text-slate-900">About</span>{" "}
//                 <span className="text-blue-600">IEEE UVCE</span>
//               </SectionTitle>

//               <div
//                 ref={ieeeRef}
//                 className={`${cardStyle} p-8 sm:p-12 fade-in-up ${ieeeVisible ? "animate" : ""}`}
//               >
//                 <div className="grid md:grid-cols-2 gap-12 items-center">
//                   <div>
//                     <MobileTruncated>
...
//               <SectionTitle>
//                 <span className="text-slate-900">About</span>{" "}
//                 <span className="text-blue-600">KAGADA</span>
//               </SectionTitle>

//               <div
//                 ref={kagadaRef}
//                 className={`${cardStyle} p-8 sm:p-12 fade-in-up ${kagadaVisible ? "animate" : ""}`}
//               >
//                 <div className="grid lg:grid-cols-2 gap-12 items-center">
//                   <div>
//                     <MobileTruncated>
...
//                   <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6">
//                     {[
//                       { icon: Star, value: "1000+", label: "Participants Expected" },
//                       { icon: Users, value: "50+", label: "Colleges Participating" },
//                       { icon: Trophy, value: "₹40K+", label: "Total Prizes" },
//                       { icon: Rocket, value: "20", label: "Years of Legacy" },
//                     ].map((stat, index) => (
//                       <div
...
//                           {stat.value}
//                         </div>
//                         <div className="text-xs sm:text-sm text-slate-900 font-poppins">
//                           {stat.label}
//                         </div>
//                       </div>
//                     ))}
...
const AboutPage = () => {
  ...
  return (
    // ✅ Added scroll-mt-24 to avoid heading being hidden behind navbar
