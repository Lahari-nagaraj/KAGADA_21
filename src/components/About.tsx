              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <p className="text-slate-700 leading-relaxed text-justify">
                    IEEE UVCE has come to be one of the most recognised Student
                    Branches across Region 10 of IEEE. Rekindled in 2001, it has
                    grown to a strength of around 400 student members. The
                    organization's commitment is reflected in activities like
                    symposiums, workshops, and our flagship events: KAGADA,
                    IMPETUS, and CodeFury. We stand by our motto “Striding
                    Ahead,” engaging the community in technical, humanitarian,
                    and societal causes. Our efforts were recognized with the
                    2023 IEEE R10 Special Recognition of Student Branch Award.
                  </p>
                </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  <p className="text-slate-700 leading-relaxed text-justify mb-6">
                    ...
                    knowledge cannot be achieved in the classroom alone. KAGADA,
                    a recipient of the Darrel Chong Platinum Level Student
                    Activity Award, provides a platform for students to pursue
                    undergraduate research, sharpen their intellect, and
                    exchange ideas.
                  </p>
                  <p className="text-slate-700 leading-relaxed text-justify">
